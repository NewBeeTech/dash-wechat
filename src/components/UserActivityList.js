    ...
    return (
      <div>
        <Accordion defaultActiveKey="0" className="my-accordion">
          <Accordion.Panel header={<div className={styles.panelHeader}><img src="./../assets/images/todo.png" />&nbsp;&nbsp;计划中的联谊</div>}>
            <List className="my-list">
              {this.renderMyDash(this.props.myDash, [1])}
            </List>
          </Accordion.Panel>
          <Accordion.Panel header={<div className={styles.panelHeader}><img src="./../assets/images/wantto.png" />&nbsp;&nbsp;想去的联谊</div>} className="pad">
            <List className="my-list">
              {this.renderCard(this.props.wantToDash)}
            </List>
          </Accordion.Panel>
          <Accordion.Panel header={<div className={styles.panelHeader}><img src="./../assets/images/history.png" />&nbsp;&nbsp;联过的谊</div>} className="pad">
            <List className="my-list">
